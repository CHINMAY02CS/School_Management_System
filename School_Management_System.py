...
lf_bg = '#176B87'  # Light Gray
cf_bg = '#8ACDD7'  # Light Cyan
rf_bg = '#176B87'  # Old Lace
...
Label(main, text="SCHOOL MANAGEMENT SYSTEM", font=headlabelfont, bg='#191919', fg='white').pack(side=TOP, fill=X)
...
right_frame = Frame(main, bg=rf_bg)
...
Button(left_frame, text='Submit and Add Record', font=labelfont, command=add_record, width=18, bg='#4CAF50', fg='black', pady=5).place(relx=0.10, rely=0.85)

# Placing components in the center frame
Button(center_frame, text='Delete Record', font=labelfont, command=remove_record, width=15, bg='#D0A2F7', fg='black', pady=5).place(relx=0.1, rely=0.25)
Button(center_frame, text='View Record', font=labelfont, command=view_record, width=15, bg='#D0A2F7', fg='black', pady=5).place(relx=0.1, rely=0.35)
Button(center_frame, text='Reset Fields', font=labelfont, command=reset_fields, width=15, bg='#D0A2F7', fg='black', pady=5).place(relx=0.1, rely=0.45)
Button(center_frame, text='Delete Database', font=labelfont, command=reset_form, width=15, bg='#D0A2F7', fg='black', pady=5).place(relx=0.1, rely=0.55)

# Placing components in the right frame
Label(right_frame, text='Students Records', font=headlabelfont, bg='#B6BBC4', fg='#2E2E2E').pack(side=TOP, fill=X)
...
column_widths = [80, 140, 180, 120, 80, 120, 150]
for i, width in enumerate(column_widths):
    tree.column('#' + str(i), width=width, stretch=NO)
